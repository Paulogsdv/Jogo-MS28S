...
public class PieceL extends Piece {
	...
	public PieceL() {
		...
		blocks.add(new Block(0, 0, Colors.ORANGE));
		blocks.add(new Block(1, 0, Colors.ORANGE));
		blocks.add(new Block(2, 0, Colors.ORANGE));
		blocks.add(new Block(0, 1, Colors.ORANGE));
		orientation = 0;
	}
